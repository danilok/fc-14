...
export function NewRoute() {
  ...
  async function searchPlaces(event: FormEvent) {
    ...
    const param = `originId=${placeSourceId}&destinationId=${placeDestinationId}`;
    const url = "http://localhost:3001/api/directions";
    const directionsResponse = await fetch(`${url}?${param}`);
